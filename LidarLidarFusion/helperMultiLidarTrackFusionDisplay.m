classdef helperMultiLidarTrackFusionDisplay < matlab.System
    ...
    methods
        function obj = helperMultiLidarTrackFusionDisplay(varargin)
    ...
    methods (Access = protected)
        function setupImpl(obj, varargin)
            ...
            setupLidarDisplay1(obj, f);
            setupLidarDisplay2(obj, f);
...
%             p = uipanel('Parent',fig,'Position',[0.75 0.5 0.25 0.5],'Title','Lidar Ego2','FontSize',16,...
%                 'FontWeight','bold',...
%                 'TitlePosition','lefttop');
...
%                 'ShowLegend',false);
%         end
        function setupLidarDisplay1(obj, fig)
        ...
        function setupLidarDisplay2(obj, fig)
            p = uipanel('Parent',fig,'Position',[0.75 0.5 0.25 0.5],...
                'Title','Lidar Ego2',...
                'FontSize',16,...
                'FontWeight','bold',...
                'TitlePosition','lefttop');
