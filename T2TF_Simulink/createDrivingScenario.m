...
secondVehicle = vehicle(scenario, 'ClassID', 1, 'Position', [55.1 -0.9 0],'PlotColor', [0.8500 0.3250 0.0980]);
waypoints = [61 -0.5 0; 138.7 -0.5 0];
speed = 12;
trajectory(secondVehicle, waypoints, speed);

% Add the third vehicle
thirdVehicle = vehicle(scenario, 'ClassID', 1, 'Position', [45.1 -0.9 0], 'PlotColor', [0.929 0.694 0.125]);
