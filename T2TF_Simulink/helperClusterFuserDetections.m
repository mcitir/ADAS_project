classdef (StrictDefaults)helperClusterFuserDetections < matlabshared.tracking.internal.SimulinkBusUtilities
...
%#codegen
    ...
    methods
        function obj = helperClusterFuserDetections(varargin)
            % Constructor
...
str = sprintf([...
    'The Detection Clustering block clusters all the detections generated by a ',...
